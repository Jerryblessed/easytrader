  ...
  Widget build(BuildContext context) {
    ...
    switch (defaultTargetPlatform) {
      ...
      case TargetPlatform.fuchsia:
        ...
        break;
      default: // Handle other platforms such as linux
        routeLabel = ''; // or provide a default label for other platforms
        break;
    }
...
PersistentBottomSheetController showMyBottomSheet({
  required BuildContext context,
  required WidgetBuilder builder,
}) =>
